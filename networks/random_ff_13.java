...
public class random_ff_13 implements ServerGraphFactory {
	...
	public void createServers1( ServerGraph sg, Server[] servers ) throws Exception {
		servers[44] = sg.addServer( "s44", factory.createServiceCurve( "SC{(0.0,0.0),24.532989008133644}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[4] = sg.addServer( "s4", factory.createServiceCurve( "SC{(0.0,0.0),12.26241955461287}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[33] = sg.addServer( "s33", factory.createServiceCurve( "SC{(0.0,0.0),12.572555735848875}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[21] = sg.addServer( "s21", factory.createServiceCurve( "SC{(0.0,0.0),22.160977820891095}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[28] = sg.addServer( "s28", factory.createServiceCurve( "SC{(0.0,0.0),9.669973602892403}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[51] = sg.addServer( "s51", factory.createServiceCurve( "SC{(0.0,0.0),15.777463676031912}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[16] = sg.addServer( "s16", factory.createServiceCurve( "SC{(0.0,0.0),9.184441102316367}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[29] = sg.addServer( "s29", factory.createServiceCurve( "SC{(0.0,0.0),14.969516390499436}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[39] = sg.addServer( "s39", factory.createServiceCurve( "SC{(0.0,0.0),18.512830716880536}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[50] = sg.addServer( "s50", factory.createServiceCurve( "SC{(0.0,0.0),52.93562982916892}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[24] = sg.addServer( "s24", factory.createServiceCurve( "SC{(0.0,0.0),49.6825919447329}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[12] = sg.addServer( "s12", factory.createServiceCurve( "SC{(0.0,0.0),39.538241334016945}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[26] = sg.addServer( "s26", factory.createServiceCurve( "SC{(0.0,0.0),13.893147372398085}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[47] = sg.addServer( "s47", factory.createServiceCurve( "SC{(0.0,0.0),11.88148753964271}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[30] = sg.addServer( "s30", factory.createServiceCurve( "SC{(0.0,0.0),3.3390304292643087}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[19] = sg.addServer( "s19", factory.createServiceCurve( "SC{(0.0,0.0),16.102022209501985}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[40] = sg.addServer( "s40", factory.createServiceCurve( "SC{(0.0,0.0),20.689867280000215}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[41] = sg.addServer( "s41", factory.createServiceCurve( "SC{(0.0,0.0),11.142999908911353}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[27] = sg.addServer( "s27", factory.createServiceCurve( "SC{(0.0,0.0),14.104657387190867}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[42] = sg.addServer( "s42", factory.createServiceCurve( "SC{(0.0,0.0),39.92540200180748}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[17] = sg.addServer( "s17", factory.createServiceCurve( "SC{(0.0,0.0),25.323915864717918}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[35] = sg.addServer( "s35", factory.createServiceCurve( "SC{(0.0,0.0),30.559906701839743}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[49] = sg.addServer( "s49", factory.createServiceCurve( "SC{(0.0,0.0),78.75051046680868}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[8] = sg.addServer( "s8", factory.createServiceCurve( "SC{(0.0,0.0),72.62044597490437}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[46] = sg.addServer( "s46", factory.createServiceCurve( "SC{(0.0,0.0),14.128419663526238}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[43] = sg.addServer( "s43", factory.createServiceCurve( "SC{(0.0,0.0),10.038346528168653}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[13] = sg.addServer( "s13", factory.createServiceCurve( "SC{(0.0,0.0),68.87037080391892}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[37] = sg.addServer( "s37", factory.createServiceCurve( "SC{(0.0,0.0),11.578372577557092}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[31] = sg.addServer( "s31", factory.createServiceCurve( "SC{(0.0,0.0),19.620005810776338}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[3] = sg.addServer( "s3", factory.createServiceCurve( "SC{(0.0,0.0),21.978014324296364}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[18] = sg.addServer( "s18", factory.createServiceCurve( "SC{(0.0,0.0),9.452765573000391}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[5] = sg.addServer( "s5", factory.createServiceCurve( "SC{(0.0,0.0),11.912568141157664}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[14] = sg.addServer( "s14", factory.createServiceCurve( "SC{(0.0,0.0),32.34945452729165}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[23] = sg.addServer( "s23", factory.createServiceCurve( "SC{(0.0,0.0),18.940022033343183}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[36] = sg.addServer( "s36", factory.createServiceCurve( "SC{(0.0,0.0),34.48897772417939}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[9] = sg.addServer( "s9", factory.createServiceCurve( "SC{(0.0,0.0),57.942826792192065}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[2] = sg.addServer( "s2", factory.createServiceCurve( "SC{(0.0,0.0),64.81736226109068}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[15] = sg.addServer( "s15", factory.createServiceCurve( "SC{(0.0,0.0),17.4226468463222}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[45] = sg.addServer( "s45", factory.createServiceCurve( "SC{(0.0,0.0),18.587249814792266}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[48] = sg.addServer( "s48", factory.createServiceCurve( "SC{(0.0,0.0),56.65064238338506}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[20] = sg.addServer( "s20", factory.createServiceCurve( "SC{(0.0,0.0),15.188704341054624}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[7] = sg.addServer( "s7", factory.createServiceCurve( "SC{(0.0,0.0),13.674896517767259}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[38] = sg.addServer( "s38", factory.createServiceCurve( "SC{(0.0,0.0),10.686055860937314}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[25] = sg.addServer( "s25", factory.createServiceCurve( "SC{(0.0,0.0),35.41014203221394}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[0] = sg.addServer( "s0", factory.createServiceCurve( "SC{(0.0,0.0),14.750571434362133}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[32] = sg.addServer( "s32", factory.createServiceCurve( "SC{(0.0,0.0),20.366576432349135}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[11] = sg.addServer( "s11", factory.createServiceCurve( "SC{(0.0,0.0),9.352135889281131}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[1] = sg.addServer( "s1", factory.createServiceCurve( "SC{(0.0,0.0),10.13984146634685}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[34] = sg.addServer( "s34", factory.createServiceCurve( "SC{(0.0,0.0),27.554048815377524}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[6] = sg.addServer( "s6", factory.createServiceCurve( "SC{(0.0,0.0),22.45781269707415}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[10] = sg.addServer( "s10", factory.createServiceCurve( "SC{(0.0,0.0),90.35810442571817}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[22] = sg.addServer( "s22", factory.createServiceCurve( "SC{(0.0,0.0),19.94639748517349}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
	}

	public void createTurns1( ServerGraph sg, Server[] servers ) throws Exception {
		sg.addTurn( "t16", servers[48], servers[36] );
		sg.addTurn( "t0", servers[45], servers[34] );
		sg.addTurn( "t76", servers[23], servers[30] );
		sg.addTurn( "t3", servers[35], servers[43] );
		sg.addTurn( "t40", servers[40], servers[8] );
		sg.addTurn( "t28", servers[18], servers[44] );
		sg.addTurn( "t94", servers[12], servers[1] );
		sg.addTurn( "t71", servers[13], servers[10] );
		sg.addTurn( "t107", servers[5], servers[25] );
		sg.addTurn( "t62", servers[25], servers[15] );
		sg.addTurn( "t6", servers[9], servers[35] );
		sg.addTurn( "t67", servers[8], servers[12] );
		sg.addTurn( "t66", servers[8], servers[11] );
		sg.addTurn( "t104", servers[5], servers[22] );
		sg.addTurn( "t112", servers[10], servers[48] );
		sg.addTurn( "t118", servers[29], servers[49] );
		sg.addTurn( "t9", servers[36], servers[8] );
		sg.addTurn( "t31", servers[4], servers[1] );
		sg.addTurn( "t35", servers[27], servers[2] );
		sg.addTurn( "t36", servers[27], servers[3] );
		sg.addTurn( "t41", servers[40], servers[9] );
		sg.addTurn( "t64", servers[37], servers[31] );
		sg.addTurn( "t101", servers[21], servers[29] );
		sg.addTurn( "t87", servers[49], servers[22] );
		sg.addTurn( "t49", servers[22], servers[44] );
		sg.addTurn( "t119", servers[29], servers[50] );
		sg.addTurn( "t74", servers[31], servers[25] );
		sg.addTurn( "t73", servers[31], servers[24] );
		sg.addTurn( "t43", servers[7], servers[41] );
		sg.addTurn( "t84", servers[24], servers[48] );
		sg.addTurn( "t113", servers[10], servers[49] );
		sg.addTurn( "t63", servers[37], servers[30] );
		sg.addTurn( "t55", servers[46], servers[12] );
		sg.addTurn( "t108", servers[50], servers[6] );
		sg.addTurn( "t1", servers[45], servers[36] );
		sg.addTurn( "t4", servers[35], servers[44] );
		sg.addTurn( "t60", servers[14], servers[24] );
		sg.addTurn( "t24", servers[6], servers[30] );
		sg.addTurn( "t51", servers[42], servers[23] );
		sg.addTurn( "t19", servers[34], servers[51] );
		sg.addTurn( "t47", servers[38], servers[33] );
		sg.addTurn( "t22", servers[32], servers[9] );
		sg.addTurn( "t29", servers[18], servers[45] );
		sg.addTurn( "t93", servers[12], servers[0] );
		sg.addTurn( "t32", servers[4], servers[2] );
		sg.addTurn( "t58", servers[14], servers[22] );
		sg.addTurn( "t45", servers[38], servers[31] );
		sg.addTurn( "t39", servers[40], servers[6] );
		sg.addTurn( "t26", servers[6], servers[33] );
		sg.addTurn( "t114", servers[10], servers[51] );
		sg.addTurn( "t61", servers[14], servers[26] );
		sg.addTurn( "t86", servers[24], servers[51] );
		sg.addTurn( "t100", servers[21], servers[27] );
		sg.addTurn( "t54", servers[42], servers[26] );
		sg.addTurn( "t46", servers[38], servers[32] );
		sg.addTurn( "t98", servers[47], servers[43] );
		sg.addTurn( "t42", servers[40], servers[10] );
		sg.addTurn( "t72", servers[31], servers[22] );
		sg.addTurn( "t83", servers[17], servers[14] );
		sg.addTurn( "t48", servers[22], servers[43] );
		sg.addTurn( "t97", servers[47], servers[42] );
		sg.addTurn( "t116", servers[51], servers[28] );
		sg.addTurn( "t5", servers[9], servers[34] );
		sg.addTurn( "t53", servers[42], servers[25] );
		sg.addTurn( "t90", servers[49], servers[26] );
		sg.addTurn( "t82", servers[15], servers[16] );
		sg.addTurn( "t15", servers[48], servers[35] );
		sg.addTurn( "t92", servers[2], servers[13] );
		sg.addTurn( "t75", servers[31], servers[26] );
		sg.addTurn( "t106", servers[5], servers[24] );
		sg.addTurn( "t12", servers[20], servers[2] );
		sg.addTurn( "t11", servers[20], servers[0] );
		sg.addTurn( "t65", servers[37], servers[32] );
		sg.addTurn( "t89", servers[49], servers[25] );
		sg.addTurn( "t8", servers[36], servers[7] );
		sg.addTurn( "t56", servers[46], servers[13] );
		sg.addTurn( "t78", servers[23], servers[33] );
		sg.addTurn( "t81", servers[19], servers[17] );
		sg.addTurn( "t91", servers[2], servers[11] );
		sg.addTurn( "t20", servers[32], servers[7] );
		sg.addTurn( "t105", servers[5], servers[23] );
		sg.addTurn( "t52", servers[42], servers[24] );
		sg.addTurn( "t30", servers[4], servers[0] );
		sg.addTurn( "t69", servers[13], servers[7] );
		sg.addTurn( "t79", servers[39], servers[40] );
		sg.addTurn( "t34", servers[27], servers[1] );
		sg.addTurn( "t70", servers[13], servers[9] );
		sg.addTurn( "t110", servers[50], servers[8] );
		sg.addTurn( "t59", servers[14], servers[23] );
		sg.addTurn( "t27", servers[18], servers[42] );
		sg.addTurn( "t7", servers[36], servers[6] );
		sg.addTurn( "t13", servers[20], servers[3] );
		sg.addTurn( "t68", servers[13], servers[6] );
		sg.addTurn( "t117", servers[29], servers[48] );
		sg.addTurn( "t99", servers[47], servers[45] );
		sg.addTurn( "t21", servers[32], servers[8] );
		sg.addTurn( "t17", servers[34], servers[49] );
		sg.addTurn( "t23", servers[32], servers[10] );
		sg.addTurn( "t18", servers[34], servers[50] );
		sg.addTurn( "t37", servers[0], servers[28] );
		sg.addTurn( "t85", servers[24], servers[50] );
		sg.addTurn( "t88", servers[49], servers[23] );
		sg.addTurn( "t109", servers[50], servers[7] );
		sg.addTurn( "t95", servers[12], servers[3] );
	}
