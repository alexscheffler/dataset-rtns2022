...
public class random_ff_19 implements ServerGraphFactory {
	...
	public void createServers1( ServerGraph sg, Server[] servers ) throws Exception {
		servers[7] = sg.addServer( "s7", factory.createServiceCurve( "SC{(0.0,0.0),9.179070029019282}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[35] = sg.addServer( "s35", factory.createServiceCurve( "SC{(0.0,0.0),4.393525598830182}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[19] = sg.addServer( "s19", factory.createServiceCurve( "SC{(0.0,0.0),30.523250562277298}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[11] = sg.addServer( "s11", factory.createServiceCurve( "SC{(0.0,0.0),7.270688618033527}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[17] = sg.addServer( "s17", factory.createServiceCurve( "SC{(0.0,0.0),21.49659163590261}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[23] = sg.addServer( "s23", factory.createServiceCurve( "SC{(0.0,0.0),8.891052602218569}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[1] = sg.addServer( "s1", factory.createServiceCurve( "SC{(0.0,0.0),10.61147565994974}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[36] = sg.addServer( "s36", factory.createServiceCurve( "SC{(0.0,0.0),10.879880264514721}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[37] = sg.addServer( "s37", factory.createServiceCurve( "SC{(0.0,0.0),10.601601545160623}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[22] = sg.addServer( "s22", factory.createServiceCurve( "SC{(0.0,0.0),13.611912514979823}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[25] = sg.addServer( "s25", factory.createServiceCurve( "SC{(0.0,0.0),8.655008967484958}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[30] = sg.addServer( "s30", factory.createServiceCurve( "SC{(0.0,0.0),38.60214016604728}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[33] = sg.addServer( "s33", factory.createServiceCurve( "SC{(0.0,0.0),28.61357924592449}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[9] = sg.addServer( "s9", factory.createServiceCurve( "SC{(0.0,0.0),5.315843786308988}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[4] = sg.addServer( "s4", factory.createServiceCurve( "SC{(0.0,0.0),10.487968878181551}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[6] = sg.addServer( "s6", factory.createServiceCurve( "SC{(0.0,0.0),3.346888866553322}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[12] = sg.addServer( "s12", factory.createServiceCurve( "SC{(0.0,0.0),51.26752003903137}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[27] = sg.addServer( "s27", factory.createServiceCurve( "SC{(0.0,0.0),11.846721676933463}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[39] = sg.addServer( "s39", factory.createServiceCurve( "SC{(0.0,0.0),15.297712720284862}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[32] = sg.addServer( "s32", factory.createServiceCurve( "SC{(0.0,0.0),32.148697262808376}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[3] = sg.addServer( "s3", factory.createServiceCurve( "SC{(0.0,0.0),8.586528117487324}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[41] = sg.addServer( "s41", factory.createServiceCurve( "SC{(0.0,0.0),7.235745382929652}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[16] = sg.addServer( "s16", factory.createServiceCurve( "SC{(0.0,0.0),17.059893502076655}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[8] = sg.addServer( "s8", factory.createServiceCurve( "SC{(0.0,0.0),12.917854609291814}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[10] = sg.addServer( "s10", factory.createServiceCurve( "SC{(0.0,0.0),16.295276236607222}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[15] = sg.addServer( "s15", factory.createServiceCurve( "SC{(0.0,0.0),9.332015926070758}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[38] = sg.addServer( "s38", factory.createServiceCurve( "SC{(0.0,0.0),7.559877141207175}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[0] = sg.addServer( "s0", factory.createServiceCurve( "SC{(0.0,0.0),5.366509938289209}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[24] = sg.addServer( "s24", factory.createServiceCurve( "SC{(0.0,0.0),20.048214170356022}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[29] = sg.addServer( "s29", factory.createServiceCurve( "SC{(0.0,0.0),28.15469983394668}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[40] = sg.addServer( "s40", factory.createServiceCurve( "SC{(0.0,0.0),10.169759903812501}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[2] = sg.addServer( "s2", factory.createServiceCurve( "SC{(0.0,0.0),65.8726912093114}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[31] = sg.addServer( "s31", factory.createServiceCurve( "SC{(0.0,0.0),9.592603721570534}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[28] = sg.addServer( "s28", factory.createServiceCurve( "SC{(0.0,0.0),68.85449030228538}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[26] = sg.addServer( "s26", factory.createServiceCurve( "SC{(0.0,0.0),7.544902382685932}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[14] = sg.addServer( "s14", factory.createServiceCurve( "SC{(0.0,0.0),7.769777928590294}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[34] = sg.addServer( "s34", factory.createServiceCurve( "SC{(0.0,0.0),49.52139706473364}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[5] = sg.addServer( "s5", factory.createServiceCurve( "SC{(0.0,0.0),42.53608851216085}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[13] = sg.addServer( "s13", factory.createServiceCurve( "SC{(0.0,0.0),7.954137488751011}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[20] = sg.addServer( "s20", factory.createServiceCurve( "SC{(0.0,0.0),8.870515959130026}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[21] = sg.addServer( "s21", factory.createServiceCurve( "SC{(0.0,0.0),40.49818892129449}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
		servers[18] = sg.addServer( "s18", factory.createServiceCurve( "SC{(0.0,0.0),15.765539717965321}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, true, true );
	}

	public void createTurns1( ServerGraph sg, Server[] servers ) throws Exception {
		sg.addTurn( "t36", servers[28], servers[1] );
		sg.addTurn( "t29", servers[7], servers[2] );
		sg.addTurn( "t34", servers[5], servers[27] );
		sg.addTurn( "t0", servers[10], servers[2] );
		sg.addTurn( "t56", servers[40], servers[2] );
		sg.addTurn( "t37", servers[28], servers[2] );
		sg.addTurn( "t7", servers[35], servers[27] );
		sg.addTurn( "t28", servers[7], servers[1] );
		sg.addTurn( "t61", servers[8], servers[13] );
		sg.addTurn( "t64", servers[27], servers[41] );
		sg.addTurn( "t9", servers[35], servers[29] );
		sg.addTurn( "t15", servers[0], servers[15] );
		sg.addTurn( "t67", servers[39], servers[29] );
		sg.addTurn( "t17", servers[25], servers[13] );
		sg.addTurn( "t33", servers[5], servers[26] );
		sg.addTurn( "t72", servers[2], servers[30] );
		sg.addTurn( "t3", servers[10], servers[5] );
		sg.addTurn( "t26", servers[11], servers[32] );
		sg.addTurn( "t24", servers[22], servers[24] );
		sg.addTurn( "t57", servers[40], servers[3] );
		sg.addTurn( "t6", servers[6], servers[37] );
		sg.addTurn( "t42", servers[30], servers[16] );
		sg.addTurn( "t11", servers[37], servers[17] );
		sg.addTurn( "t20", servers[29], servers[20] );
		sg.addTurn( "t12", servers[18], servers[36] );
		sg.addTurn( "t35", servers[5], servers[29] );
		sg.addTurn( "t45", servers[17], servers[32] );
		sg.addTurn( "t50", servers[34], servers[20] );
		sg.addTurn( "t38", servers[28], servers[3] );
		sg.addTurn( "t60", servers[8], servers[12] );
		sg.addTurn( "t51", servers[34], servers[21] );
		sg.addTurn( "t65", servers[39], servers[26] );
		sg.addTurn( "t2", servers[10], servers[4] );
		sg.addTurn( "t18", servers[25], servers[15] );
		sg.addTurn( "t54", servers[4], servers[41] );
		sg.addTurn( "t75", servers[24], servers[21] );
		sg.addTurn( "t73", servers[2], servers[31] );
		sg.addTurn( "t41", servers[38], servers[18] );
		sg.addTurn( "t22", servers[21], servers[27] );
		sg.addTurn( "t69", servers[32], servers[3] );
		sg.addTurn( "t1", servers[10], servers[3] );
		sg.addTurn( "t10", servers[37], servers[16] );
		sg.addTurn( "t40", servers[38], servers[17] );
		sg.addTurn( "t77", servers[9], servers[39] );
		sg.addTurn( "t74", servers[24], servers[19] );
		sg.addTurn( "t44", servers[17], servers[31] );
		sg.addTurn( "t25", servers[11], servers[30] );
		sg.addTurn( "t13", servers[0], servers[12] );
		sg.addTurn( "t23", servers[21], servers[28] );
		sg.addTurn( "t47", servers[33], servers[14] );
		sg.addTurn( "t21", servers[21], servers[26] );
		sg.addTurn( "t48", servers[33], servers[15] );
		sg.addTurn( "t55", servers[40], servers[1] );
		sg.addTurn( "t58", servers[40], servers[5] );
		sg.addTurn( "t52", servers[19], servers[33] );
		sg.addTurn( "t8", servers[35], servers[28] );
		sg.addTurn( "t31", servers[7], servers[5] );
		sg.addTurn( "t49", servers[12], servers[34] );
		sg.addTurn( "t43", servers[30], servers[18] );
		sg.addTurn( "t70", servers[32], servers[4] );
		sg.addTurn( "t39", servers[28], servers[4] );
		sg.addTurn( "t46", servers[33], servers[13] );
		sg.addTurn( "t78", servers[9], servers[40] );
		sg.addTurn( "t66", servers[39], servers[28] );
		sg.addTurn( "t19", servers[29], servers[19] );
		sg.addTurn( "t62", servers[8], servers[14] );
		sg.addTurn( "t16", servers[25], servers[12] );
		sg.addTurn( "t71", servers[32], servers[5] );
		sg.addTurn( "t76", servers[20], servers[23] );
		sg.addTurn( "t14", servers[0], servers[14] );
		sg.addTurn( "t30", servers[7], servers[4] );
		sg.addTurn( "t68", servers[32], servers[1] );
	}
